<template>
  <div class="login">
    <el-container>
        ...
        <div class="left_pic">
          ...
          <div class="loginPicture">
            <a href target="_blank">
              <img src="https://s4.51cto.com/images/blog/202006/15/4f905930fce458ec9e16d4d953f6e276.jpg" alt="登录图片" />
            </a>
          </div>
        </div>
        ...
        <div class="right_form">
          ...
          <el-form ref="loginForm" :rules="rules" :model="user" v-if="isFirst" class="loginForm">
            ...
            <el-form-item prop="studentPassword">
              <el-input v-model="user.studentPassword" type="password" placeholder="请输入密码" autocomplete="off">
              </el-input>
            </el-form-item>
            <el-form-item>
              ...
              <router-link :to="{path:'/register',query:{flag:'forget'}}">
          ...
          <!-- 免密登录  -->
          <el-form ref="unclassifiedForm" :model="user" :rules="rules1" v-else class="unclassifiedForm">
      ...
      <el-footer class="foot"></el-footer>
    </el-container>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      ...
      count() {
        ...
        this.$refs.unclassifiedForm.validateField("no_secret_studentPhone", phoneError => {
          if (!phoneError) {
